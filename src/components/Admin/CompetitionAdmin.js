...
import JudgeFinals from './JudgeFinals'
		...
		<>
			<AppBar position='static' color='primary'>
				<Tabs value={value} onChange={onChange} aria-label=''>
					...
					<Tab label='Judge Finals' value={'judge'}/>
				</Tabs>
			</AppBar>
			...
			<TabPanel value={value} index='judge'>
				<JudgeFinals competitionId={match.params.competitionId} />
			</TabPanel>
		</>
	)
}
